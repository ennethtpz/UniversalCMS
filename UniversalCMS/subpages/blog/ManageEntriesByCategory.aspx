<%@ Page Title="" Language="C#" MasterPageFile="~/master/main.master" AutoEventWireup="true" CodeBehind="ManageEntriesByCategory.aspx.cs" Inherits="UniversalCMS.subpages.blog.ManageEntriesByCategory" %>
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="/managecategories"><i class="fa fa-pencil"> Manage Blog Categories</i></a></li>
                        <li class="active"><i class="fa fa-book"> Manage Blog Articles Per Category</i></li>
                    </ol>
                </section>
